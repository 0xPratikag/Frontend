      ...
      <header className="sticky top-0 z-30 backdrop-blur bg-white/90 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h1 className="text-lg md:text-xl font-bold text-slate-900">India Therapy Centre</h1>
              <p className="text-sm text-slate-500">Care • Support • Progress</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-600">
            ...
            <a href="#testimonials" className="hover:text-blue-700 transition-colors">Reviews</a>
